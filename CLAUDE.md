...
those checks show *skipped*, not failed. "CI green" ≠ "e2e passed". The one
exception is `packages/integrations/mercado-livre/**`, which `ci-mercado-livre.yml`
picks up for an integration-level Firestore lane (still not an e2e).
