...
| `historico-v2`  | Every row is v2 and the sum **reconciles**. The trail genuinely records the movements that produced the negative.                                                                                                                     | `ultimasLinhas` names the writer directly — `tipo`, `motivo`, `pedidoNumero`. Read it and fix the writer.                           |
