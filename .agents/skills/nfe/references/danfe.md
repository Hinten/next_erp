...
fiscal document (the signed XML is); the DANFE only _accompanies_ the goods and
...
| **Etiqueta ZPL2** _(ours)_  | 10×15 cm       | Net-new vs. the legacy PDF etiqueta — streams ZPL directly to a Zebra.                                                                  |
