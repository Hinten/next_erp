...
| `actionsPanel`               | `boolean \| { defaultCollapsed?: boolean; width?: number }` — opt-in action panel docked to the right of the table. When enabled it **replaces** the top ActionBar ("Novo" / "Copiar" / bulk `actions` move into it, still acting on the current selection). Collapses to a slim rail; collapsed state persists per collection in localStorage. `width` widens the expanded rail past its 220px default.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
