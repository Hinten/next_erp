 ...
 * (44 characters). The TableView's NF cell subscribes to the latest doc
 * (orderBy `ultima_modificacao` desc, limit 1 — NOT `timestamp`, which this
 * schema never sets) to display the current state; see `useLatestNfe`.
 */
