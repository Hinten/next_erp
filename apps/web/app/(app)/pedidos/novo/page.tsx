...
import { createPedidoWithNumero } from '@/lib/pedidos/createPedido';
...
export default function NovoPedidoPage() {
  ...
  async function handleSubmit(values: Pedido) {
    ...
    const id = await createPedidoWithNumero(getFirebaseFirestore(), values);
    router.replace(`/pedidos/${id}/editar`);
  }
