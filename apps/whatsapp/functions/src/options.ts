...
// Defaults to us-east5 (matches the WhatsApp task scheduler's default region);
// override via FUNCTIONS_REGION.
...
process.env.WHATSAPP_TASKS_REGION =
  (process.env.WHATSAPP_TASKS_REGION?.trim() || undefined) ?? region;
