...
vi.mock('../import/importMigration', () => ({ handleUptinMigration: h.handleUptinMigration }));
vi.mock('../orders/orderImport', () => ({ importPedidoMercadoLivre: h.importPedidoMercadoLivre }));
vi.mock('../orders/orderPaymentImport', () => ({
  importPagamentoMercadoLivre: h.importPagamentoMercadoLivre,
}));
vi.mock('../orders/orderShipmentImport', () => ({
...
vi.mock('../preco/itemsPricesSync', async (importActual) => {
  const actual = await importActual<typeof import('../preco/itemsPricesSync')>();
