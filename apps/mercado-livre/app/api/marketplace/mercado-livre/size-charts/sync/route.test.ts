...
import { TabelaDeMedidasNotFoundError } from '@/lib/marketplace/publish/sizeChartSync';
...
vi.mock('@/lib/marketplace/publish/sizeChartSync', async (importActual) => {
  const actual = await importActual<typeof import('@/lib/marketplace/publish/sizeChartSync')>();
