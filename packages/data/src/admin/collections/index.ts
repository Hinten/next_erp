...
export { historicoModificacaoClienteCollection } from './historicoModificacaoClienteCollection';
export { historicoModificacaoOperacaoCollection } from './historicoModificacaoOperacaoCollection';
