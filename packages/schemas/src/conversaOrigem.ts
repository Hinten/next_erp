 ...
 *
 * Every value below is copied verbatim from the legacy source with the exact
...
export const ORIGEM_RULES: Record<OrigemConversa, OrigemRule> = {
  ...
  // limite 300 (L1014); permiteAnexo true (default); maximoAnexos 1 (L1069);
  // formats L1085; size 25 MB (L1101); isHtml true (L1028).
  mlped: {
  ...
  // limite 300 (L1016); permiteAnexo true (default); maximoAnexos 3 (L1071);
  // formats L1087; size 25 MB (L1103); isHtml true (L1030).
  mlclaims: {
    limiteCaracteres: 300,
    permiteAnexo: true,
    maximoAnexos: 3,
