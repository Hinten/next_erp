...
export const ALL_DOMAINS: ReadonlyArray<DomainSchema<z.ZodTypeAny>> = [
  ...
  integracao,
  brandShopee,
  // ⚠️ LEGACY-GRANT ONLY — remove all four with the Flutter decommission (#829).
  ...
  // ⚠️ That parity buys this app nothing — there is no dual run (root
  // `CLAUDE.md` rule 8) — so #829 removes surface, it does not wait on anything.
