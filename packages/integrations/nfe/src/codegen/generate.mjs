 ...
 *
 * Reads the vendored SEFAZ XSD packs in `generated/moc<ACTIVE_MOC>/schemas/`
 * and emits `generated/moc<ACTIVE_MOC>/types/nfe-schema.ts` (plus the Zod
 * mirror below). Not `src/types/` — those two files are re-export shims the
 * generator never writes to.
 *
